...
export default function EmployeeHome() {
  return (
    ...
    <div style={{display:'flex'}}>
        <div style={{position:'fixed'}}><EmployeeNav/></div>
        <div style={{backgroundImage:`url("wallpaper.jpg")`}} className='adminhome'>
            <div className='layer2' style={{height:600}}>
                <div className='text'>
    ...
    <div className='line'></div>
        <div style={{backgroundImage:`url("table.jpg")`, marginLeft:50}} className='adminhome1'>
        ...
        <div style={{marginLeft:0}}><Footer/></div>
    </div>
  )
}
